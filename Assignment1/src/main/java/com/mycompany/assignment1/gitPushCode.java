...
public class gitPushCode {
    public void openGitbash() throws IOException{
        String[] command = {"C:/Program Files/Git/git-bash.exe",
            "/c","cd && cd 243122-STIW3054-A172-A1 && git add * && git commit -m \"Commit\" && git push"};
    ...
    public void runTerminal() throws IOException{
        ...
        ProcessBuilder builder = new ProcessBuilder(
            "cmd.exe", "/c", "cd && cd \"C:\\Users\\Azmir\\243122-STIW3054-A172-A1 \" && git add * && git commit -m \"Update file\" && git push");
